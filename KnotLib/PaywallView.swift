...
struct PaywallView: View {
    ...
    private let benefits: [(String, String, String)] = [
        ("books.vertical.fill", "All 20+ knots", "Every knot unlocked — bends, hitches, loops, bindings and more."),
        ("figure.strengthtraining.traditional", "Daily Drill", "A new knot each day, walked through step by step to build muscle memory."),
        ("checkmark.seal.fill", "Mark mastered", "Track which knots you've nailed; your progress syncs across your devices."),
        ("square.and.arrow.up.fill", "Share knots", "Send any knot's steps to a friend in one tap.")
    ]
            ...
            ScrollView {
                VStack(spacing: 22) {
                    ...
                    VStack(spacing: 12) {
                        ...
                        Text("Knot Library never tracks you. Everything works offline.")
