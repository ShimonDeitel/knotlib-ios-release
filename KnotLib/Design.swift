...
extension Color {
    static let klAccent = Color(hex: "#007AFF")          // the single accent
    static let klCard = Color(uiColor: .secondarySystemBackground)
    static let klCard2 = Color(uiColor: .tertiarySystemBackground)
    static let klField = Color(uiColor: .tertiarySystemFill)
    static let klHair = Color(uiColor: .separator)
}

// MARK: - Flat surfaces (cards / pills / buttons)

extension View {
    func klCard(cornerRadius: CGFloat = 20) -> some View {
        self.padding(16)
            .background(Color.klCard, in: RoundedRectangle(cornerRadius: cornerRadius, style: .continuous))
    }

    func klPill() -> some View {
        self.padding(.horizontal, 14).padding(.vertical, 8)
            .background(Color.klCard, in: Capsule())
    }
...
struct FilledAccentButtonStyle: ButtonStyle {
    func makeBody(configuration: Configuration) -> some View {
        configuration.label
            ...
            .background(Color.klAccent, in: Capsule())
